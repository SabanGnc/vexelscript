...
if old_noclip in text:
    ...
    print("Error: Could not find exactly old_noclip. Here's a fuzzy substitute.")
    # Fallback if there was a slight mismatch
    import re
    text = re.sub(r'local noclipConnection\nlocal noclipVelocity.*?\nend\)', new_noclip, text, flags=re.DOTALL)

with open(filepath, 'w', encoding='utf-8') as f:
    f.write(text)

print("Noclip V3 rebuilt")
